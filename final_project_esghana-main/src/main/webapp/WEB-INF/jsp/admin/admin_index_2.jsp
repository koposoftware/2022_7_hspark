...
#sidebar-menu ul.metismenu>li.mm-active>a {
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="mb-1 mt-1"><span class="counter-value" data-target="1241"></span>명</h4>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="mb-1 mt-1">₩<span class="counter-value" data-target="258410450">0</span></h4>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <h4 class="mb-1 mt-1"><span class="counter-value" data-target="17">0</span></h4>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col-->
	...
	<div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  ...
	  <form enctype="multipart/form-data" action="${ pageContext.request.contextPath }/admin/donationInsert" method="post">
        ...
        var options = {
                series: [{
                data: [100, 200,500,300,451,521,666]
              }],
                chart: {                    
                height: 300,
                type: 'horizontal',
              ...
              xaxis: {
                categories: 
                   /* 가로축 배열 */
                   ['하나은행','하나금융지주','하나금융투자','하나제약','하나카드','하나투어','하나캐피탈']
        ...
        options = {
            ...
            series: [{
                data: [380, 430, 450, 475, 550, 584, 780]
            }],
            colors: ["#0ab39c"],
            grid: {
                borderColor: "#f1f1f1"
            ...
            xaxis: {
                categories:  ['하나은행','하나금융지주','하나금융투자','하나제약','하나카드','하나투어','하나캐피탈']
            }
        };
