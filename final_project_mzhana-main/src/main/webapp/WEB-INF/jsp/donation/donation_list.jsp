            ...
            <div class="row text-center">
                <c:forEach items="${ donationList }" var="doantion" varStatus="status">
	                <div class="mt-4 col-4 ">
						...
						<c:if test="${num < 6}"> 
							<div class="me-2" style="height: 500px; border-radius:15px; background-image: url('/resources/images/donation/donation${num}.png');background-size: cover;">
							<div style="height: 80px">
		                        <div style="color:#008485; position: relative; top: 290px; text-align: left; margin-left: 15px; padding: 5px; margin-right: 15px; background-color: white;  width: fit-content; border-radius: 10px; opacity: 0.85;">
		                        	<h4 style="color:#008485;">${doantion.donationTitle}</h4>
		                        </div>
							</div>
		                        <div style="position: relative; top: 257px; width: 340px; text-align: left; margin-left: 15px; padding: 5px; margin-right: 15px; height: 70px; background-color: white;  width: fit-content; border-radius: 10px; opacity: 0.85;"">
		                        	<p class="text-box" style="font-weight: bold;">
		                        		${doantion.donationInfo}
		                       		</p>
		                       	</div>
		                        <div style="position: relative; top:285px;">
			                        <a href="${ pageContext.request.contextPath }/donationDetail/${doantion.donationNo}" class="btn" style=" background-color:#509090; color: white; font-weight: bold;">
			                        	바로 후원하기
			                        </a>
		                        </div>
		                    </div>
