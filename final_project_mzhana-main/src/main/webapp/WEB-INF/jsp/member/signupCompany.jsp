    ...
    <section class="sm-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mt-5" style="position: sticky">
	                <div style=" width:320px; height:200px; background-color: rgba(241, 243, 244, 1); padding: 20px 20px; border:1px solid white; border-radius: 30p; position: sticky">
	                    <div class="mt-2">
                ...
                <div class="col-lg-8 mt-5">
	                        ...
	                        <form name="companyCheck1" autocapitalize="off">
		                        <div class="row">
			                        <div class="col-lg-10">
				                        ...
				                        <div class="row g-3">
				                        	<div class="col-lg-2 d-flex align-items-center">
				                            	<p style="font-weight: bold;">회사 이메일</p>
				                            </div>
				                        	
				                            <div class="col-lg-10">
				                                <div class="form-floating mb-3">
				                                    <input type="email" class="form-control" id="companyemail" placeholder="Your name" name="companyemail"/>
				                                    <label class="text-muted" for="name">이메일을 입력해주세요</label>
				                                </div>
                        ...
                        <div class="ms-2 mb-4">
	                        ...
	                        <form name="companyCheck1" autocapitalize="off">
		                        <div class="row">
			                        <div class="col-lg-10">
				                        ...
				                        <div class="row g-3">
				                            ...
				                            <div class="col-lg-10">
				                                ...
				                                <div class="form-floating mb-3">
				                                    <input type="email" class="form-control" id="authNum" placeholder="Your name" name="companyemail"/>
				                                    <label class="text-muted" for="name">인증번호를 입력하세요</label>
				                                </div>
				                                <div id="confirmMsg">
				                                <!-- <div class="col-lg-10" id="companyOK" style="margin-top: -1px; padding-left: 15px;">
				                                	<font style="color: #008485;">인증되었습니다.</font>
			                        ...
			                        <div class="col-lg-2">
	                                	<input type="button" id="checkNum" class="submitBnt btn rounded w-100" style="height: 55px; background-color: rgba(241, 243, 244, 1); font-weight: bold;"
	                                    value="인증하기" />
			                        </div>
                        		</div>
		                    </form>
                    ...
                    <form action="${ pageContext.request.contextPath }/signup" method="post">
                    	...
                    	<div class="ms-2 mb-4">
	                        ...
	                        <div class="row g-3">
	                        	<div class="col-lg-2 d-flex align-items-center">
	                            	<p style="font-weight: bold;">부서</p>
	                            </div>
	                        	
	                            <div class="col-lg-10">
	                                <div class="form-floating mb-3">
	                                    <input type="text" class="form-control" id="email" placeholder="Your name" name="email"/>
	                                    <label class="text-muted" for="name">부서를 입력해주세요</label>
	                                </div>
	                            </div>
	                        </div>
                        ...
                        <input id="companyCodeId" type="hidden" value="cp01" name="companyCode">
