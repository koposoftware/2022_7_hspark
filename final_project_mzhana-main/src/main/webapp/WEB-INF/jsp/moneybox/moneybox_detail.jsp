		...
		<div id="donate" class="modal" style="max-width: 500px; max-height: 450px; padding: 70px 100px;">
			<div class="mt-4 align-items-center">
	            ...
	            <form action="/donateNow" method="post">
	                ...
	                <ul class="list-unstyled list-inline border-bottom py-3 mb-0">
	                    <li class="list-inline-item">
	                        <h5 class="fs-15 mb-0 fw-semibold">기부일</h5>
	                    </li>
	                    <li class="list-inline-item float-end text-dark text-primary">${sysdate}</li>
	                </ul>
	                ...
	                <ul class="list-unstyled list-inline py-3 mb-0">
	                    ...
	                    <li class="list-inline-item fs-16 fw-semibold text-dark float-end">
	                    	<fmt:formatNumber value="${moneyBox.balance}" pattern="#,###"/>
	                    </li>
	                </ul>
