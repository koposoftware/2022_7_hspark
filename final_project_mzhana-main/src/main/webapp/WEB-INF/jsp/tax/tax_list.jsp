                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            ...
                            <article class="post position-relative pb-5">
                                <div
                                    class="date-box rounded-3 text-center position-absolute top-0 start-0" style="margin-left: 240px; margin-top: -15px;">
                                    <img src="/resources/images/medalc.gif" style="width: 80px;"
                                             />
                                </div>
                                <div class="post-preview mb-4" style="padding-left: 50px;">
                                    <a href="single-post.html"><img src="/resources/images/donation/tax002.png" alt=""
                                            class="img-fluid rounded-3" width="300px"/></a>
                                </div>
                                <div class="post" style="margin-left: 70px;">
                                    ...
                                    <a href="${ pageContext.request.contextPath }/taxDetail/${donationHistory.donationHistoryNo}" class="fw-bold " style="padding: 5px;background-color: #008485; margin-top: 15px; border-radius: 10px; color: white;" >연말정산하러가기<i
